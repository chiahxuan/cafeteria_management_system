...
<body>
    ...
    <div class="top">
        ...
        <div class="notif_setting_cage">
            ...
            <form class="notif_setting_stack" action = "../server.php" method="POST">
                <button type = 'submit'>Log Out</h2>
            </form>
        </div>
           ...
           <div class="analysis_cage">
                ...
                <div class="analysis_bottom">
                    ...
                    <div id="Vendor" class="tabcontent">
                        <div id="columnchart_values" style="width: 100%; height: 90%; "> rhrhrhrth</div>
                        <div class="report_displayType">
                            <div class="report_type_button tab_colour">
                                Chart View
                            </div>
